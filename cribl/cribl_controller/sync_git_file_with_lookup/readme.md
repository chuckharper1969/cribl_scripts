...
Not this is just a one way from Git to Cribl and no lookups are deleted in Cribl that are not in Git repo. This can be accomplished but this would make this repo the source of record for all lookups in Cribl unless specific exceptions are made or pattern matching exceptions.?
