...
# cribl_get_outputs
##############################################################################
def cribl_get_outputs_status_by_id(cribl_connection, output_id, verify=False):
    ...
    endpoint = f"{cribl_connection['url']}/api/v1/m/{cribl_connection['group']}/system/status/outputs/{output_id}"
...
def main():
    ...
    cribl_output_items = cribl_get_outputs_status_by_id(cribl_conn, output_id)
