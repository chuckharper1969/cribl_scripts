...
# cribl_get_outputs
##############################################################################
def cribl_get_outputs_by_id(cribl_connection, output_id, verify=False):
...
def main():
    ...
    cribl_output_item = cribl_get_outputs_by_id(cribl_conn, output_id)
    
    output_object = cribl_output_item["items"][0]
    print(output_object)
