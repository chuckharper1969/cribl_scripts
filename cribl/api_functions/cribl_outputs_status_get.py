...
# cribl_get_outputs
##############################################################################
def cribl_get_outputs_status(cribl_connection):
    ...
    endpoint = f"{cribl_connection['url']}/api/v1/m/{cribl_connection['group']}/system/status/outputs"
...
def main():
    ...
    cribl_output_items = cribl_get_outputs_status(cribl_conn)
